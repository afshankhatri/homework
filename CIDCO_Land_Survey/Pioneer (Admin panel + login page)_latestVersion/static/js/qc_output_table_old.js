...
function applyFilter() {
 ...
 // JavaScript to validate all checkboxes before allowing submission
 document.getElementById('submit-checkbox').addEventListener('click', function (event) {
    const sectionCheckboxes = document.querySelectorAll('.section-checkbox');
    let allChecked = true;

    // Check if all section checkboxes are checked
    ...
    if (!allChecked) {
        ...
        alert('Please verify all sections before submitting.');
        this.checked = false; // Uncheck the submit checkbox
    } else {
        alert('Form verified.');
    }
});