...
window.onload = function() {
    // Fetch data from the Flask route and pass it to entrypointfordata
    fetchDataFromFlask();
};
...
function fetchDataFromFlask() {
    ...
    .then(data => {
        ...
        entrypointfordata(data); // Pass the data to the entrypointfordata function
    })
    .catch(error => {
...
function entrypointfordata(data) {
    console.log("Data passed to entrypointfordata:", data);
    // Your logic to handle the fetched data goes here
